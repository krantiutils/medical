...
const socialLinks = [
  {
    label: "Facebook",
    href: "https://facebook.com/doctorsewa",
    icon: (
  ...
  {
    label: "Twitter",
    href: "https://twitter.com/doctorsewa",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/doctorsewa",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path
          fillRule="evenodd"
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/doctorsewa",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path
          fillRule="evenodd"
            ...
            <div className="lg:max-w-sm">
              ...
              >
                ...
                <div className="flex items-center gap-1">
                  ...
                  <div className="w-5 h-5 bg-primary-red" />
                  <div
                    className="w-5 h-5 bg-primary-yellow"
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 flex items-center justify-center bg-white/10 hover:bg-white/20 transition-colors border border-white/20"
        ...
        <div className="px-4 lg:px-8 py-6">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="w-2 h-2 bg-primary-red" />
              <div
                className="w-2 h-2 bg-primary-yellow"
                style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
              />
